...
function excluirCurso(cod){
    ...
    if(confirm("Atenção! Você tem certeza que deseja excluir esse curso?\nEsta ação não poderá ser desfeita")){
        ...
        {  
            ...
            {
                itens.push("<tr> <td>" + this.codigo + "</td><td>" + this.nome + "</td><td class='text-center'><img id='"+this.codigo+"' src='../img/edit.svg' alt='' width='20px' style='cursor:pointer' onClick='buscarCursoCod(this.id)'></td><td class='text-center'>" + "<img id='"+this.codigo+"' src='../img/delete.svg' alt='' width='20px' style='cursor:pointer' onClick='excluirCurso(this.id)'>" + "</td></tr>");
