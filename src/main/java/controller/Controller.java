...
public class Controller {
	...
	public void cadastrarCurso(){
		get("/cadastrarCurso/:codigo/:nome/:categoria/:descricao/:duracao", (req, res) -> {
			...
			model.cadastrarCurso(new Curso(Integer.parseInt(req.params(":codigo")), req.params(":nome"), 
					req.params(":duracao"), req.params(":descricao"), true, "img/course_default.jpg", req.params(":categoria"), modulos));	
	...
	public void cadastrarUsuario()	{
		get("/cadastrarUsuario/:login/:senha/:email/:nome", (req, res) -> {
			...
			model.cadastrarUsuario(new Usuario(model.autoincrement(), req.params(":login"), req.params(":senha"), req.params(":email"), 
